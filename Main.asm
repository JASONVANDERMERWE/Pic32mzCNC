_main:
;Main.c,25 :: 		void main() {
;Main.c,29 :: 		int xyz_ = 0;
;Main.c,30 :: 		PinMode();
JAL	_PinMode+0
NOP	
;Main.c,32 :: 		StepperConstants(5000,15500);
ORI	R26, R0, 15500
ORI	R25, R0, 5000
...
;Main.c,37 :: 		disable_steps = 0;
SH	R0, Offset(main_disable_steps_L0+0)(GP)
;Main.c,38 :: 		DisableStepper();
...
NOP	
L__main46:
;Main.c,42 :: 		LED1 = TMR.clock >> 4;
LBU	R2, Offset(_TMR+0)(GP)
SRL	R3, R2, 4
_LX	
INS	R2, R3, BitPos(LED1+0), 1
_SX	
;Main.c,43 :: 		if(disable_steps <= SEC_TO_DISABLE_STEPPERS)
...
NOP	
L__main47:
;Main.c,44 :: 		disable_steps = TMR.Reset(SEC_TO_DISABLE_STEPPERS,disable_steps);
...
;Main.c,49 :: 		}else if(!LED1 && (oneshot == 1))
J	L_main7
NOP	
;Main.c,45 :: 		if(LED1 && (oneshot == 0)){
L__main36:
...
SH	R0, Offset(main_disable_steps_L0+0)(GP)
;Main.c,66 :: 		EnStepperX();
JAL	_EnStepperX+0
NOP	
;Main.c,67 :: 		EnStepperY();
JAL	_EnStepperY+0
NOP	
;Main.c,68 :: 		EnStepperZ();
JAL	_EnStepperZ+0
NOP	
;Main.c,69 :: 		EnStepperA();
JAL	_EnStepperA+0
NOP	
;Main.c,61 :: 		if((!SW1)&&(!Toggle)){
L__main40:
...
NOP	
L__main57:
;Main.c,74 :: 		if((!OC5IE_bit && !OC2IE_bit && !OC7IE_bit && !OC3IE_bit)){
_LX	
...
L__main61:
L__main31:
;Main.c,75 :: 		sprintf(txt_,"%d",STPS[X].step_count);
...
NOP	
ADDIU	SP, SP, 12
;Main.c,76 :: 		UART2_Write_Text(txt_);
LUI	R25, hi_addr(_txt_+0)
ORI	R25, R25, lo_addr(_txt_+0)
JAL	_UART2_Write_Text+0
NOP	
;Main.c,77 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
;Main.c,78 :: 		sprintf(txt_,"%d",STPS[Y].step_count);
...
NOP	
ADDIU	SP, SP, 12
;Main.c,79 :: 		UART2_Write_Text(txt_);
LUI	R25, hi_addr(_txt_+0)
ORI	R25, R25, lo_addr(_txt_+0)
JAL	_UART2_Write_Text+0
NOP	
;Main.c,80 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
...
;Main.c,94 :: 		case 0:
L_Temp_Move22:
;Main.c,95 :: 		STPS[X].mmToTravel = belt_steps(-50.00);//calcSteps(-50.00,8.06);
LUI	R2, 49736
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
...
;Main.c,96 :: 		speed_cntr_Move(STPS[X].mmToTravel, 15000,X);
MOVZ	R27, R0, R0
ORI	R26, R0, 15000
MOVZ	R25, R2, R0
...
;Main.c,99 :: 		case 1:
L_Temp_Move23:
;Main.c,100 :: 		STPS[X].mmToTravel = belt_steps(50.00);//calcSteps(50.00,8.06);
LUI	R2, 16968
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
NOP	
SW	R2, Offset(_STPS+64)(GP)
;Main.c,101 :: 		speed_cntr_Move(STPS[X].mmToTravel, 15000,X);
MOVZ	R27, R0, R0
ORI	R26, R0, 15000
MOVZ	R25, R2, R0
JAL	_speed_cntr_Move+0
...
;Main.c,104 :: 		case 2:
L_Temp_Move24:
;Main.c,105 :: 		STPS[Y].mmToTravel = belt_steps(50.00);//calcSteps(50.00,8.06);
LUI	R2, 16968
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
...
;Main.c,106 :: 		speed_cntr_Move(STPS[Y].mmToTravel, 15000,Y);
ORI	R27, R0, 1
ORI	R26, R0, 15000
MOVZ	R25, R2, R0
JAL	_speed_cntr_Move+0
...
;Main.c,109 :: 		case 3:
L_Temp_Move25:
;Main.c,110 :: 		STPS[Y].mmToTravel = belt_steps(-50.00);//calcSteps(-50.00,8.06);
LUI	R2, 49736
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
NOP	
SW	R2, Offset(_STPS+132)(GP)
;Main.c,111 :: 		speed_cntr_Move(STPS[Y].mmToTravel, 15000,Y);
ORI	R27, R0, 1
ORI	R26, R0, 15000
MOVZ	R25, R2, R0
JAL	_speed_cntr_Move+0
...
;Main.c,114 :: 		case 4:
L_Temp_Move26:
;Main.c,115 :: 		STPS[Y].mmToTravel = belt_steps(50.00);//calcSteps(50.00,8.06);
LUI	R2, 16968
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
NOP	
SW	R2, Offset(_STPS+132)(GP)
;Main.c,116 :: 		speed_cntr_Move(STPS[Y].mmToTravel, 15000,Y);
ORI	R27, R0, 1
ORI	R26, R0, 15000
MOVZ	R25, R2, R0
JAL	_speed_cntr_Move+0
NOP	
;Main.c,117 :: 		STPS[X].mmToTravel = belt_steps(-100.00);//calcSteps(-50.00,8.06);
LUI	R2, 49864
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
NOP	
SW	R2, Offset(_STPS+64)(GP)
;Main.c,118 :: 		speed_cntr_Move(STPS[X].mmToTravel, 15000,X);
MOVZ	R27, R0, R0
ORI	R26, R0, 15000
MOVZ	R25, R2, R0
JAL	_speed_cntr_Move+0
...
;Main.c,121 :: 		case 5:
L_Temp_Move27:
;Main.c,122 :: 		STPS[Y].mmToTravel = belt_steps(-50.00);//calcSteps(-50.00,8.06);
LUI	R2, 49736
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
NOP	
SW	R2, Offset(_STPS+132)(GP)
;Main.c,123 :: 		speed_cntr_Move(STPS[Y].mmToTravel, 15000,Y);
ORI	R27, R0, 1
ORI	R26, R0, 15000
MOVZ	R25, R2, R0
JAL	_speed_cntr_Move+0
NOP	
;Main.c,124 :: 		STPS[X].mmToTravel = belt_steps(100.00);//calcSteps(50.00,8.06);
LUI	R2, 17096
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
NOP	
SW	R2, Offset(_STPS+64)(GP)
;Main.c,125 :: 		speed_cntr_Move(STPS[X].mmToTravel, 15000,X);
MOVZ	R27, R0, R0
ORI	R26, R0, 15000
MOVZ	R25, R2, R0
JAL	_speed_cntr_Move+0
...
;Main.c,130 :: 		speed_cntr_Move(STPS[A].mmToTravel, 55000,A);
ORI	R27, R0, 3
ORI	R26, R0, 55000
MOVZ	R25, R2, R0
JAL	_speed_cntr_Move+0
...
;Main.c,133 :: 		case 7:
L_Temp_Move29:
;Main.c,135 :: 		r_or_ijk(450.00, 250.00, 486.00, 386.00, 0.00, -100.00, 100.00, 0.00,xy);
LUI	R5, 17345
ORI	R5, R5, 0
LUI	R4, 17395
ORI	R4, R4, 0
