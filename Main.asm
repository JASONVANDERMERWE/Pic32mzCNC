...
JAL	_UART2_Write_Text+0
NOP	
;Main.c,86 :: 		sprintf(txt_,"%d",STPS[X].step_count);
ADDIU	R3, SP, 0
...
NOP	
ADDIU	SP, SP, 12
;Main.c,87 :: 		UART2_Write_Text(" | step_count[X]:= ");
ADDIU	R23, SP, 14
ADDIU	R22, R23, 20
...
JAL	_UART2_Write_Text+0
NOP	
;Main.c,88 :: 		UART2_Write_Text(txt_);
ADDIU	R2, SP, 0
MOVZ	R25, R2, R0
JAL	_UART2_Write_Text+0
NOP	
;Main.c,89 :: 		sprintf(txt_,"%d",sys.axis_dir[X]);
ADDIU	R3, SP, 0
...
NOP	
ADDIU	SP, SP, 12
;Main.c,90 :: 		UART2_Write_Text(" | axis_dir[X]:= ");
ADDIU	R23, SP, 34
ADDIU	R22, R23, 18
...
JAL	_UART2_Write_Text+0
NOP	
;Main.c,91 :: 		UART2_Write_Text(txt_);
ADDIU	R2, SP, 0
MOVZ	R25, R2, R0
JAL	_UART2_Write_Text+0
NOP	
;Main.c,92 :: 		sprintf(txt_,"%d",sys.steps_position[X]);
ADDIU	R3, SP, 0
...
NOP	
ADDIU	SP, SP, 12
;Main.c,93 :: 		UART2_Write_Text(" | absX:= ");
ADDIU	R23, SP, 52
ADDIU	R22, R23, 11
...
JAL	_UART2_Write_Text+0
NOP	
;Main.c,94 :: 		UART2_Write_Text(txt_);
ADDIU	R2, SP, 0
MOVZ	R25, R2, R0
JAL	_UART2_Write_Text+0
NOP	
;Main.c,95 :: 		sprintf(txt_,"%d",STPS[Y].step_count);
ADDIU	R3, SP, 0
...
NOP	
ADDIU	SP, SP, 12
;Main.c,96 :: 		UART2_Write_Text(" | step_count[Y]:= ");
ADDIU	R23, SP, 63
ADDIU	R22, R23, 20
...
JAL	_UART2_Write_Text+0
NOP	
;Main.c,97 :: 		UART2_Write_Text(txt_);
ADDIU	R2, SP, 0
MOVZ	R25, R2, R0
JAL	_UART2_Write_Text+0
NOP	
;Main.c,98 :: 		sprintf(txt_,"%d",sys.axis_dir[Y]);
ADDIU	R3, SP, 0
...
NOP	
ADDIU	SP, SP, 12
;Main.c,99 :: 		UART2_Write_Text(" | axis_dir[Y]:= ");
ADDIU	R23, SP, 83
ADDIU	R22, R23, 18
...
JAL	_UART2_Write_Text+0
NOP	
;Main.c,100 :: 		UART2_Write_Text(txt_);
ADDIU	R2, SP, 0
MOVZ	R25, R2, R0
JAL	_UART2_Write_Text+0
NOP	
;Main.c,101 :: 		sprintf(txt_,"%d",sys.steps_position[Y]);
ADDIU	R3, SP, 0
...
NOP	
ADDIU	SP, SP, 12
;Main.c,102 :: 		UART2_Write_Text(" | absY:= ");
ADDIU	R23, SP, 101
ADDIU	R22, R23, 11
...
JAL	_UART2_Write_Text+0
NOP	
;Main.c,103 :: 		UART2_Write_Text(txt_);
ADDIU	R2, SP, 0
MOVZ	R25, R2, R0
JAL	_UART2_Write_Text+0
NOP	
;Main.c,104 :: 		UART2_Write(0x0D);
ORI	R25, R0, 13
JAL	_UART2_Write+0
NOP	
...
;Main.c,100 :: 		switch(a){
=======
;Main.c,117 :: 		void Temp_Move(int a){
ADDIU	SP, SP, -16
SW	RA, 0(SP)
;Main.c,119 :: 		switch(a){
>>>>>>> patch2
...
;Main.c,120 :: 		case 0:
L_Temp_Move22:
;Main.c,121 :: 		STPS[X].mmToTravel = belt_steps(-50.00);//calcSteps(-125.25,8.06);
>>>>>>> patch2
LUI	R2, 49736
ORI	R2, R2, 0
MTC1	R2, S12
...
<<<<<<< HEAD
;Main.c,103 :: 		speed_cntr_Move(STPS[X].mmToTravel, 2000,X);
MOVZ	R27, R0, R0
ORI	R26, R0, 2000
MOVZ	R25, R2, R0
...
;Main.c,106 :: 		case 2:
L_Temp_Move23:
;Main.c,107 :: 		STPS[X].mmToTravel = belt_steps(50.00);
LUI	R2, 16968
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
NOP	
SW	R2, Offset(_STPS+64)(GP)
;Main.c,108 :: 		speed_cntr_Move(STPS[X].mmToTravel, 8000,X);
=======
;Main.c,122 :: 		speed_cntr_Move(STPS[X].mmToTravel, 8000,X);
>>>>>>> patch2
MOVZ	R27, R0, R0
ORI	R26, R0, 8000
MOVZ	R25, R2, R0
...
=======
;Main.c,123 :: 		SingleAxisStep(STPS[X].mmToTravel,X);
>>>>>>> patch2
MOVZ	R26, R0, R0
LW	R25, Offset(_STPS+64)(GP)
JAL	_SingleAxisStep+0
...
;Main.c,111 :: 		case 1:
L_Temp_Move24:
;Main.c,112 :: 		STPS[Y].mmToTravel = belt_steps(50.00);
=======
;Main.c,124 :: 		break;
J	L_Temp_Move21
NOP	
;Main.c,125 :: 		case 2:
L_Temp_Move23:
;Main.c,126 :: 		STPS[X].mmToTravel = belt_steps(50.00);
LUI	R2, 16968
ORI	R2, R2, 0
MTC1	R2, S12
JAL	_belt_steps+0
...
JAL	_speed_cntr_Move+0
NOP	
;Main.c,128 :: 		SingleAxisStep(STPS[X].mmToTravel,X);
MOVZ	R26, R0, R0
LW	R25, Offset(_STPS+64)(GP)
JAL	_SingleAxisStep+0
NOP	
...
;Main.c,130 :: 		case 1:
L_Temp_Move24:
;Main.c,131 :: 		STPS[Y].mmToTravel = belt_steps(50.00);
>>>>>>> patch2
LUI	R2, 16968
ORI	R2, R2, 0
MTC1	R2, S12
...
<<<<<<< HEAD
;Main.c,113 :: 		speed_cntr_Move(STPS[Y].mmToTravel, 5000,Y);
=======
;Main.c,132 :: 		speed_cntr_Move(STPS[Y].mmToTravel, 8000,Y);
>>>>>>> patch2
ORI	R27, R0, 1
ORI	R26, R0, 8000
MOVZ	R25, R2, R0
...
=======
;Main.c,133 :: 		SingleAxisStep(STPS[Y].mmToTravel,Y);
>>>>>>> patch2
ORI	R26, R0, 1
...
=======
;Main.c,137 :: 		speed_cntr_Move(STPS[Y].mmToTravel, 8000,Y);
ORI	R27, R0, 1
ORI	R26, R0, 8000
MOVZ	R25, R2, R0
JAL	_speed_cntr_Move+0
NOP	
;Main.c,138 :: 		SingleAxisStep(STPS[Y].mmToTravel,Y);
ORI	R26, R0, 1
LW	R25, Offset(_STPS+132)(GP)
JAL	_SingleAxisStep+0
NOP	
...
;Main.c,140 :: 		case 4:
L_Temp_Move26:
;Main.c,141 :: 		STPS[X].mmToTravel = belt_steps(-50.00);
>>>>>>> patch2
LUI	R2, 49736
ORI	R2, R2, 0
MTC1	R2, S12
...
=======
;Main.c,143 :: 		STPS[Y].mmToTravel = belt_steps(100.00);
>>>>>>> patch2
LUI	R2, 17096
ORI	R2, R2, 0
MTC1	R2, S12
...
=======
;Main.c,144 :: 		speed_cntr_Move(STPS[Y].mmToTravel, 8000,Y);
>>>>>>> patch2
ORI	R27, R0, 1
ORI	R26, R0, 8000
MOVZ	R25, R2, R0
...
=======
;Main.c,145 :: 		DualAxisStep(STPS[X].mmToTravel, STPS[Y].mmToTravel,xy);
>>>>>>> patch2
MOVZ	R27, R0, R0
LW	R26, Offset(_STPS+132)(GP)
LW	R25, Offset(_STPS+64)(GP)
...
;Main.c,147 :: 		case 5:
L_Temp_Move27:
;Main.c,148 :: 		STPS[X].mmToTravel = belt_steps(50.00);
>>>>>>> patch2
LUI	R2, 16968
ORI	R2, R2, 0
MTC1	R2, S12
...
=======
;Main.c,150 :: 		STPS[Y].mmToTravel = belt_steps(-100.00);
>>>>>>> patch2
LUI	R2, 49864
ORI	R2, R2, 0
MTC1	R2, S12
...
=======
;Main.c,151 :: 		speed_cntr_Move(STPS[Y].mmToTravel, 8000,Y);
>>>>>>> patch2
ORI	R27, R0, 1
ORI	R26, R0, 8000
MOVZ	R25, R2, R0
...
=======
;Main.c,152 :: 		DualAxisStep(STPS[X].mmToTravel, STPS[Y].mmToTravel,xy);
>>>>>>> patch2
MOVZ	R27, R0, R0
LW	R26, Offset(_STPS+132)(GP)
LW	R25, Offset(_STPS+64)(GP)
...
;Main.c,154 :: 		case 6:
L_Temp_Move28:
;Main.c,155 :: 		STPS[X].mmToTravel = belt_steps(-150.00);
>>>>>>> patch2
LUI	R2, 49942
ORI	R2, R2, 0
MTC1	R2, S12
...
SW	R2, Offset(_STPS+64)(GP)
<<<<<<< HEAD
;Main.c,137 :: 		speed_cntr_Move(STPS[X].mmToTravel, 10000,X);
=======
...
=======
;Main.c,157 :: 		STPS[Y].mmToTravel = belt_steps(100.00);
>>>>>>> patch2
LUI	R2, 17096
ORI	R2, R2, 0
MTC1	R2, S12
...
=======
;Main.c,159 :: 		DualAxisStep(STPS[X].mmToTravel, STPS[Y].mmToTravel,xy);
>>>>>>> patch2
MOVZ	R27, R0, R0
MOVZ	R26, R2, R0
LW	R25, Offset(_STPS+64)(GP)
...
;Main.c,161 :: 		case 7:
L_Temp_Move29:
;Main.c,162 :: 		STPS[X].mmToTravel = belt_steps(150.00);
>>>>>>> patch2
LUI	R2, 17174
ORI	R2, R2, 0
MTC1	R2, S12
...
SW	R2, Offset(_STPS+64)(GP)
<<<<<<< HEAD
;Main.c,144 :: 		speed_cntr_Move(STPS[X].mmToTravel, 10000,X);
=======
;Main.c,163 :: 		speed_cntr_Move(STPS[X].mmToTravel, 8000,X);
>>>>>>> patch2
MOVZ	R27, R0, R0
ORI	R26, R0, 8000
MOVZ	R25, R2, R0
...
=======
;Main.c,164 :: 		STPS[Y].mmToTravel = belt_steps(-100.00);
>>>>>>> patch2
LUI	R2, 49864
ORI	R2, R2, 0
MTC1	R2, S12
...
=======
;Main.c,166 :: 		DualAxisStep(STPS[X].mmToTravel, STPS[Y].mmToTravel,xy);
>>>>>>> patch2
MOVZ	R27, R0, R0
MOVZ	R26, R2, R0
LW	R25, Offset(_STPS+64)(GP)
...
;Main.c,168 :: 		case 8:
L_Temp_Move30:
;Main.c,169 :: 		STPS[A].mmToTravel = belt_steps(150.00);
>>>>>>> patch2
LUI	R2, 17174
ORI	R2, R2, 0
MTC1	R2, S12
...
=======
;Main.c,170 :: 		speed_cntr_Move(STPS[A].mmToTravel, 15000,A);
>>>>>>> patch2
ORI	R27, R0, 3
ORI	R26, R0, 15000
MOVZ	R25, R2, R0
...
=======
;Main.c,171 :: 		SingleAxisStep(STPS[A].mmToTravel,A);
>>>>>>> patch2
ORI	R26, R0, 3
...
;Main.c,154 :: 		case 9:
L_Temp_Move31:
;Main.c,156 :: 		r_or_ijk(-50.00, 50.00, -150.00, 150.00, 0.00, -50.00, 50.00,1.0, 0.00);
=======
;Main.c,172 :: 		break;
J	L_Temp_Move21
NOP	
;Main.c,173 :: 		case 9:
L_Temp_Move31:
;Main.c,175 :: 		r_or_ijk(-50.00, 50.00, -150.00, 150.00, 0.00, -50.00, 50.00,1.0, 0.00);
>>>>>>> patch2
LUI	R5, 17174
ORI	R5, R5, 0
LUI	R4, 49942
...
=======
;Main.c,182 :: 		void LCD_Display(){
ADDIU	SP, SP, -20
SW	RA, 0(SP)
;Main.c,187 :: 		sprintf(txt,"%d",STPS[0].accel_lim);
>>>>>>> patch2
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
...
=======
;Main.c,188 :: 		I2C_LCD_Out(LCD_01_ADDRESS,1,1,txt);
>>>>>>> patch2
...
=======
;Main.c,190 :: 		sprintf(txt,"%d",STPS[0].decel_start);
>>>>>>> patch2
...
=======
;Main.c,191 :: 		I2C_LCD_Out(LCD_01_ADDRESS,1,11,txt);
>>>>>>> patch2
LUI	R28, hi_addr(_txt+0)
ORI	R28, R28, lo_addr(_txt+0)
ORI	R27, R0, 11
...
=======
;Main.c,195 :: 		sprintf(txt,"%d",STPS[0].step_delay);
>>>>>>> patch2
...
=======
;Main.c,196 :: 		I2C_LCD_Out(LCD_01_ADDRESS,2,1,txt);
>>>>>>> patch2
LUI	R28, hi_addr(_txt+0)
ORI	R28, R28, lo_addr(_txt+0)
ORI	R27, R0, 1
...
=======
;Main.c,198 :: 		sprintf(txt,"%d",STPS[0].min_delay);
>>>>>>> patch2
...
=======
;Main.c,199 :: 		I2C_LCD_Out(LCD_01_ADDRESS,2,11,txt);
>>>>>>> patch2
LUI	R28, hi_addr(_txt+0)
ORI	R28, R28, lo_addr(_txt+0)
ORI	R27, R0, 11
...
=======
;Main.c,203 :: 		sprintf(txt,"%d",STPS[0].max_step_lim);
>>>>>>> patch2
...
=======
;Main.c,204 :: 		I2C_LCD_Out(LCD_01_ADDRESS,3,1,txt);
>>>>>>> patch2
LUI	R28, hi_addr(_txt+0)
ORI	R28, R28, lo_addr(_txt+0)
ORI	R27, R0, 1
...
=======
;Main.c,206 :: 		sprintf(txt,"%d",STPS[0].decel_val);
>>>>>>> patch2
...
=======
;Main.c,207 :: 		I2C_LCD_Out(LCD_01_ADDRESS,3,11,txt);
>>>>>>> patch2
LUI	R28, hi_addr(_txt+0)
ORI	R28, R28, lo_addr(_txt+0)
ORI	R27, R0, 11
