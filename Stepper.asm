...
NOP	
L__DualAxisStep278:
; ?FLOC___DualAxisStep?T462 start address is: 12 (R3)
ORI	R3, R0, 1
; ?FLOC___DualAxisStep?T462 end address is: 12 (R3)
J	L_DualAxisStep77
NOP	
L_DualAxisStep76:
; ?FLOC___DualAxisStep?T462 start address is: 12 (R3)
...
NOP	
L__DualAxisStep290:
; ?FLOC___DualAxisStep?T505 start address is: 12 (R3)
ORI	R3, R0, 1
; ?FLOC___DualAxisStep?T505 end address is: 12 (R3)
J	L_DualAxisStep103
NOP	
L_DualAxisStep102:
; ?FLOC___DualAxisStep?T505 start address is: 12 (R3)
...
NOP	
L__DualAxisStep291:
; ?FLOC___DualAxisStep?T507 start address is: 12 (R3)
ORI	R3, R0, 1
; ?FLOC___DualAxisStep?T507 end address is: 12 (R3)
J	L_DualAxisStep105
NOP	
L_DualAxisStep104:
; ?FLOC___DualAxisStep?T507 start address is: 12 (R3)
...
_CalcRadius:
;Stepper.c,488 :: 		void CalcRadius(Circle* cir){
ADDIU	SP, SP, -16
SW	RA, 0(SP)
;Stepper.c,491 :: 		cir->xRad = fabs(cir->xStart + cir->I);
ADDIU	R2, R25, 48
SW	R2, 12(SP)
ADDIU	R2, R25, 56
LWC1	S1, 0(R2)
...
LW	R2, 12(SP)
SWC1	S0, 0(R2)
;Stepper.c,492 :: 		cir->yRad = fabs(cir->yStart + cir->J);
ADDIU	R2, R25, 52
SW	R2, 12(SP)
ADDIU	R2, R25, 60
LWC1	S1, 0(R2)
...
LW	R2, 12(SP)
SWC1	S0, 0(R2)
;Stepper.c,493 :: 		cir->radius = sqrt((cir->xRad*cir->xRad) + (cir->yRad*cir->yRad));
ADDIU	R2, R25, 40
SW	R2, 12(SP)
ADDIU	R2, R25, 48
LWC1	S0, 0(R2)
...
LW	R2, 12(SP)
SWC1	S0, 0(R2)
;Stepper.c,494 :: 		angA = atan2(cir->yRad,cir->xRad);
ADDIU	R2, R25, 48
LWC1	S1, 0(R2)
ADDIU	R2, R25, 52
LWC1	S0, 0(R2)
...
JAL	_atan2+0
NOP	
;Stepper.c,497 :: 		cir->degreeDeg = angA * rad2deg;
ADDIU	R3, R25, 4
LUI	R2, 16997
ORI	R2, R2, 12013
MTC1	R2, S1
MUL.S 	S0, S0, S1
SWC1	S0, 0(R3)
;Stepper.c,499 :: 		cir->quadrant_start = QuadrantStart(cir->I,cir->J);
ADDIU	R2, R25, 46
SW	R2, 12(SP)
ADDIU	R2, R25, 32
LWC1	S1, 0(R2)
...
LW	R3, 12(SP)
SH	R2, 0(R3)
;Stepper.c,501 :: 		if(cir->quadrant_start == 1 || cir->quadrant_start == 3)
ADDIU	R2, R25, 46
LH	R2, 0(R2)
SEH	R3, R2
ORI	R2, R0, 1
...
L__CalcRadius218:
L__CalcRadius217:
;Stepper.c,502 :: 		angB = cir->deg - cir->degreeDeg;
LWC1	S1, 0(R25)
ADDIU	R2, R25, 4
LWC1	S0, 0(R2)
SUB.S 	S0, S1, S0
SWC1	S0, 8(SP)
L_CalcRadius132:
;Stepper.c,503 :: 		if(cir->quadrant_start == 1 || cir->quadrant_start == 3)
ADDIU	R2, R25, 46
LH	R2, 0(R2)
SEH	R3, R2
ORI	R2, R0, 1
...
L__CalcRadius220:
L__CalcRadius219:
;Stepper.c,504 :: 		angB = cir->deg + cir->degreeDeg;
LWC1	S1, 0(R25)
ADDIU	R2, R25, 4
LWC1	S0, 0(R2)
ADD.S 	S0, S1, S0
SWC1	S0, 8(SP)
L_CalcRadius135:
;Stepper.c,506 :: 		cir->degreeRadians = angB * deg2rad;
ADDIU	R3, R25, 8
LWC1	S1, 8(SP)
LUI	R2, 15502
ORI	R2, R2, 64046
...
; end of _CalcRadius
_QuadrantStart:
;Stepper.c,509 :: 		int QuadrantStart(float i,float j){
;Stepper.c,510 :: 		if((i <= 0)&&(j >= 0))
MOVZ	R2, R0, R0
MTC1	R2, S0
C.LT.S 	0, S0, S12
...
_CircDir:
;Stepper.c,522 :: 		void CircDir(Circle* cir){
;Stepper.c,524 :: 		if(cir->dir == CW){
ADDIU	R2, R25, 44
LH	R2, 0(R2)
SEH	R2, R2
...
NOP	
L__CircDir328:
;Stepper.c,525 :: 		newDeg = 360 / cir->deg;
LWC1	S1, 0(R25)
LUI	R2, 17332
ORI	R2, R2, 0
MTC1	R2, S0
...
MOV.S 	S3, S2
;Stepper.c,526 :: 		cir->N = (2*Pi*cir->radius)/newDeg;
ADDIU	R3, R25, 36
ADDIU	R2, R25, 40
LWC1	S1, 0(R2)
LUI	R2, 16585
...
DIV.S 	S0, S0, S2
SWC1	S0, 0(R3)
;Stepper.c,527 :: 		cir->divisor = cir->deg / newDeg;
ADDIU	R2, R25, 20
LWC1	S0, 0(R25)
DIV.S 	S0, S0, S3
...
NOP	
L__CircDir329:
;Stepper.c,531 :: 		cir->deg = 0.00;
SW	R0, 0(R25)
L_CircDir153:
;Stepper.c,532 :: 		if(cir->dir == CCW)
ADDIU	R2, R25, 44
LH	R2, 0(R2)
SEH	R3, R2
ORI	R2, R0, 1
...
; end of _CircDir
_Cir_Interpolation:
;Stepper.c,536 :: 		void Cir_Interpolation(float xPresent,float yPresent,Circle* cir){
ADDIU	SP, SP, -4
SW	RA, 0(SP)
;Stepper.c,538 :: 		cir->xStart = xPresent;
ADDIU	R2, R25, 56
SWC1	S12, 0(R2)
;Stepper.c,539 :: 		cir->yStart = yPresent;
ADDIU	R2, R25, 60
SWC1	S13, 0(R2)
;Stepper.c,540 :: 		CalcRadius(cir);
JAL	_CalcRadius+0
NOP	
;Stepper.c,543 :: 		while(quad){
...
_disableOCx:
;Stepper.c,557 :: 		void disableOCx(){
;Stepper.c,558 :: 		OC5IE_bit = 0;OC5CONbits.ON = 0;
LUI	R2, BitMask(OC5IE_bit+0)
ORI	R2, R2, BitMask(OC5IE_bit+0)
_SX	
ORI	R3, R0, 32768
SW	R3, Offset(OC5CONbits+4)(GP)
;Stepper.c,559 :: 		OC3IE_bit = 0;OC3CONbits.ON = 0;
LUI	R2, BitMask(OC3IE_bit+0)
ORI	R2, R2, BitMask(OC3IE_bit+0)
_SX	
SW	R3, Offset(OC3CONbits+4)(GP)
;Stepper.c,560 :: 		OC8IE_bit = 0;OC8CONbits.ON = 0;
LUI	R2, BitMask(OC8IE_bit+0)
ORI	R2, R2, BitMask(OC8IE_bit+0)
_SX	
SW	R3, Offset(OC8CONbits+4)(GP)
...
_min_:
;Stepper.c,675 :: 		unsigned int min_(unsigned int x, unsigned int y){
;Stepper.c,676 :: 		if(x < y){
ANDI	R3, R25, 65535
ANDI	R2, R26, 65535
SLTU	R2, R3, R2
...
NOP	
L__min_358:
;Stepper.c,677 :: 		return x;
ANDI	R2, R25, 65535
J	L_end_min_
NOP	
;Stepper.c,678 :: 		}
L_min_184:
;Stepper.c,680 :: 		return y;
ANDI	R2, R26, 65535
;Stepper.c,682 :: 		}
L_end_min_:
JR	RA
