...
;Kinematics.c,121 :: 		STPS[X].master = 1;
LBU	R2, Offset(_STPS+4)(GP)
ORI	R2, R2, 16
SB	R2, Offset(_STPS+4)(GP)
;Kinematics.c,122 :: 		STPS[Y].master = 0;
...
SLL	R2, R2, 1
SW	R2, Offset(_SV+12)(GP)
;Kinematics.c,126 :: 		STPS[X].master = 0;
LBU	R2, Offset(_STPS+4)(GP)
INS	R2, R0, 4, 1
SB	R2, Offset(_STPS+4)(GP)
;Kinematics.c,127 :: 		STPS[Y].master = 1;
LBU	R2, Offset(_STPS+72)(GP)
ORI	R2, R2, 16
SB	R2, Offset(_STPS+72)(GP)
;Kinematics.c,128 :: 		}
...
;Kinematics.c,131 :: 		STPS[Y].step_count = 0;
SW	R0, Offset(_STPS+100)(GP)
;Kinematics.c,132 :: 		AxisPulse[1]();
LW	R30, Offset(_AxisPulse+4)(GP)
JALR	RA, R30
NOP	
;Kinematics.c,134 :: 		break;
J	L_DualAxisStep17
NOP	
...
SUBU	R2, R25, R2
SW	R2, Offset(_SV+16)(GP)
;Kinematics.c,141 :: 		SV.dz   = newy - SV.pz;
...
SW	R0, Offset(_STPS+32)(GP)
;Kinematics.c,161 :: 		STPS[Z].step_count = 0;
SW	R0, Offset(_STPS+168)(GP)
;Kinematics.c,162 :: 		AxisPulse[1]();
LW	R30, Offset(_AxisPulse+4)(GP)
JALR	RA, R30
NOP	
;Kinematics.c,163 :: 		break;
J	L_DualAxisStep17
NOP	
...
SUBU	R2, R25, R2
SW	R2, Offset(_SV+20)(GP)
;Kinematics.c,171 :: 		SV.dz   = newy - SV.py;
LW	R2, Offset(_SV+36)(GP)
SUBU	R2, R26, R2
SW	R2, Offset(_SV+24)(GP)
...
SW	R0, Offset(_STPS+100)(GP)
;Kinematics.c,190 :: 		STPS[Z].step_count = 0;
SW	R0, Offset(_STPS+168)(GP)
;Kinematics.c,191 :: 		AxisPulse[1]();
LW	R30, Offset(_AxisPulse+4)(GP)
JALR	RA, R30
NOP	
;Kinematics.c,192 :: 		break;
J	L_DualAxisStep17
NOP	
;Kinematics.c,193 :: 		default: break;
L_DualAxisStep51:
J	L_DualAxisStep17
NOP	
;Kinematics.c,195 :: 		}
...
_r_or_ijk:
;Kinematics.c,215 :: 		void r_or_ijk(double Cur_axis_a,double Cur_axis_b,double Fin_axis_a,double Fin_axis_b,double r, double i, double j, double k, int axis_xyz){
ADDIU	SP, SP, -100
SW	RA, 0(SP)
SW	R25, 4(SP)
SW	R26, 8(SP)
...
;Kinematics.c,216 :: 		unsigned short isclockwise = 0;
;Kinematics.c,217 :: 		double inverse_feed_rate = -1; // negative inverse_feed_rate means no inverse_feed_rate specified
;Kinematics.c,221 :: 		double x = 0.00;
;Kinematics.c,222 :: 		double y = 0.00;
; y start address is: 24 (R6)
MTC1	R0, S3
;Kinematics.c,223 :: 		double h_x2_div_d = 0.00;
;Kinematics.c,227 :: 		position[X] = Cur_axis_a;
ADDIU	R2, SP, 20
SWC1	S12, 0(R2)
;Kinematics.c,228 :: 		position[Y] = Cur_axis_b;
ADDIU	R2, R2, 4
SWC1	S13, 0(R2)
;Kinematics.c,229 :: 		target[X] = Fin_axis_a;
ADDIU	R2, SP, 44
SWC1	S14, 0(R2)
;Kinematics.c,230 :: 		target[Y] = Fin_axis_b;
ADDIU	R2, R2, 4
SWC1	S15, 0(R2)
;Kinematics.c,231 :: 		offset[X] = i;
ADDIU	R2, SP, 68
SWC1	S1, 0(R2)
;Kinematics.c,232 :: 		offset[Y] = j;
ADDIU	R2, R2, 4
SWC1	S2, 0(R2)
;Kinematics.c,233 :: 		if(axis_xyz == xy){
SEH	R2, R25
...
;Kinematics.c,234 :: 		axis_plane_a = X;
SH	R0, 92(SP)
;Kinematics.c,235 :: 		axis_plane_b = Y;
ORI	R2, R0, 1
SH	R2, 94(SP)
;Kinematics.c,236 :: 		}else if(axis_xyz == xz){
J	L_r_or_ijk53
NOP	
L_r_or_ijk52:
; y start address is: 24 (R6)
...
L__r_or_ijk126:
; y end address is: 24 (R6)
;Kinematics.c,237 :: 		axis_plane_a = X;
SH	R0, 92(SP)
;Kinematics.c,238 :: 		axis_plane_b = Z;
ORI	R2, R0, 2
SH	R2, 94(SP)
;Kinematics.c,239 :: 		}else if(axis_xyz == yz){
J	L_r_or_ijk55
NOP	
L_r_or_ijk54:
; y start address is: 24 (R6)
...
;Kinematics.c,308 :: 		x = target[axis_plane_a] - position[axis_plane_a];
ADDIU	R5, SP, 44
LHU	R2, 92(SP)
SLL	R3, R2, 2
ADDU	R2, R5, R3
...
MOV.S 	S5, S3
;Kinematics.c,310 :: 		y = target[axis_plane_b] - position[axis_plane_b];
LHU	R2, 94(SP)
SLL	R3, R2, 2
ADDU	R2, R5, R3
LWC1	S1, 0(R2)
...
NOP	
L__r_or_ijk130:
;Kinematics.c,343 :: 		h_x2_div_d = -h_x2_div_d;
MOVZ	R2, R0, R0
MTC1	R2, S0
SUB.S 	S0, S0, S1
; h_x2_div_d end address is: 8 (R2)
...
MOV.S 	S3, S0
;Kinematics.c,344 :: 		r = -r; // Finished with r. Set to positive for mc_arc
MOVZ	R2, R0, R0
MTC1	R2, S0
SUB.S 	S0, S0, S4
...
;Kinematics.c,355 :: 		}
L_r_or_ijk60:
;Kinematics.c,358 :: 		isclockwise = false;
...
SUB.S 	S0, S0, S1
SWC1	S0, 32(SP)
;Kinematics.c,377 :: 		double rt_axis0                = target[X] - center_axis0;
SUB.S 	S0, S2, S4
...
;Kinematics.c,492 :: 		STPS[X].step_delay = 100;
ORI	R2, R0, 100
SW	R2, Offset(_STPS+8)(GP)
;Kinematics.c,493 :: 		STPS[Y].step_delay = 100;
ORI	R2, R0, 100
...
ADDIU	SP, SP, -20
SW	RA, 0(SP)
;Kinematics.c,508 :: 		int str_len = 0;
SW	R25, 4(SP)
SW	R26, 8(SP)
SW	R27, 12(SP)
